      ...
      <ThemedView style={styles.container}>
        ...
        >
          ...
          <View style={[styles.mapContainer, {
            ...
            <View style={styles.mapHeader}>
              ...
              <TouchableOpacity 
                style={[styles.fullscreenButton, { backgroundColor: Colors.light.primary }]}
        ...
        >
          <View style={styles.fullscreenMapContainer}>
            <View style={[styles.fullscreenMapHeader, { paddingTop: insets.top + 10 }]}>
              <TouchableOpacity 
              ...
              <ThemedText style={styles.fullscreenMapTitle}>
                Mapa de Laboratorios
              </ThemedText>
              <View style={styles.mapControls}>
                <TouchableOpacity style={styles.mapControlButton}>
                  <Ionicons name="layers" size={20} color={Colors.light.white} />
                </TouchableOpacity>
              </View>
            </View>
            <MapboxMap
